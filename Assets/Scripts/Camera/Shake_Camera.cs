...
public class Shake_Camera : MonoBehaviour
{
    ...
    {
        return new Vector2(Random.Range(-0.05f, 0.05f), Random.Range(-0.05f, 0.05f));
    }

    public Vector2 VerticalV2()
    {
        return new Vector2(0, Random.Range(-0.05f, 0.05f));
    }

    public Vector2 HorizontalV2()
    {
        return new Vector2(Random.Range(-0.05f, 0.05f), 0);
    }
